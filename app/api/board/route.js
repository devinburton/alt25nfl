...
export async function GET(){try{
 const current=await getCurrentWeekBundle(),[seasonGames,odds]=await Promise.all([getSeasonScoreboard(current.year,current.seasonType),fetchLiveNflTotals()]),om=new Map(odds.map(o=>[`${norm(o.away)}-${norm(o.home)}`,o]));
